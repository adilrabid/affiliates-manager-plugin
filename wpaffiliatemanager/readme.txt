...
- Fixed a vulnerability issue in the registration form.
...
= 2.9.51 =
- Fixed an issue related to payout file generation.

= 2.9.50 =
- Fixed an issue with updating payment details from affiliate profile.
...
= 2.9.44 =
- Added support for overriding templates.

= 2.9.43 =
- Translation support for messages in the settings.
...
= 2.9.39 =
- fixed a PHP notice related to Function _load_textdomain_just_in_time call.

= 2.9.38 =
- WooCommerce integration updated.

= 2.9.37 =
- Added an action hook after an affiliate's profile is updated.
...
= 2.9.34 =
- Added Chinese (Hong Kong) language translation to the plugin. The translation was submitted by Cloud Chan.

= 2.9.33 =
- Fixed a type in the en_GB language file.

= 2.9.32 =
- Improved ajax functionalities.

= 2.9.31 =
- Made some improvements to debug logging suggested by Patchstack.
